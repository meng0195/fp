...
public class GasTime extends Thread{
	...
	public GasTime(String houseNo, Date testDate, String planCode){
		this.houseNo = houseNo;
		this.datas = new TestGas(TypeCheck.TIME.val(), houseNo, planCode, testDate);
	...
	private void insertAll(){
		...
		if(an != null && an.getNums() > 0){
			...
			MsgUtil.insertMsg(datas.getHouseNo(), "气体检测异常!", TypeMsg.WARN.val(), Constant.W_GAN, datas.getId());
		}
