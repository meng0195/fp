 ...
 * @date	2018-02-24
 */
public class ModelARMDio implements CtrModel{
	
	private static final Log log = Logs.getLog(ModelARMDio.class); 
	
	String armIP = "";
	
	public ModelARMDio(EquipIps ips){
