...
@Comment("粮情检测数据备份")
@Table("TestDataCopy")
public class TestDataCopy extends IdEntry {
	...
	public TestDataCopy(TestData td){
		setId(td.getId());
		this.houseNo = td.getHouseNo();
		this.testDate = td.getTestDate();
		this.testType = td.getTestType();
		this.planCode = td.getPlanCode();
		this.inT = td.getInT();
		...
		this.tset = td.getTset();
		this.warns = td.getWarns();
		this.layerTs = td.getLayerTs();
		this.testWarns = td.getTestWarns();
		this.testTag = td.getTestTag();
		this.layT = td.getLayT();
		this.ventT = td.getVentT();
		this.topT = td.getTopT();
		this.ccT = td.getCcT();
		this.reportFlag = td.getReportFlag();
		this.curveFlag = td.getCurveFlag();
		this.areaTs = td.getAreaTs();
	}
