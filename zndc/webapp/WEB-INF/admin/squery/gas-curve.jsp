...
<form id="pagerForm" onsubmit="return navTabSearch(this);" action="${CTX_PATH}/squery/gas/curve" method="post">
...
<div width="100%" layoutH="30">
	<div id="squery-gas-curve" style="width:95%;height:450px;margin:0 auto;"></div>
</div>
<script type="text/javascript">
var myGasChart = echarts.init(document.getElementById("squery-gas-curve"));
