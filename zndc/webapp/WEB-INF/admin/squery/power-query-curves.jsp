...
<div class="pageHeader">
	<form id="pagerPieForm" onsubmit="return navTabSearch(this);" action="${CTX_PATH}/squery/power/curves" method="post">
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<th>仓房：</th>
					<td>
						<select id="squery-curves-houseNo" name="qt.houseNo" class="combox">
...
<div width="100%" layoutH="30">
	<div id="squery-curves" style="width:65%;height:450px;margin:0 auto;"></div>
</div>
<script type="text/javascript">
var myChart = echarts.init(document.getElementById("squery-curves"));
