...
<form id="pagerForm" onsubmit="return navTabSearch(this);" action="${CTX_PATH}/squery/temp/curve" method="post">
...
<div width="100%" layoutH="30">
	<div id="squery-curve" style="width:95%;height:450px;margin:0 auto;"></div>
</div>
<script type="text/javascript">
var myChart = echarts.init(document.getElementById("squery-curve"));
var datas = eval('(' + '${json}' + ')');
option = {
	//title : {
	//	text: datas.title,
