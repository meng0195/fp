...
<form id="pagerForm" onsubmit="return navTabSearch(this);" action="${CTX_PATH}/squery/pest/curve" method="post">
...
<div width="100%" layoutH="30">
	<div id="squery-pest-curve" style="width:95%;height:450px;margin:0 auto;"></div>
</div>
<script type="text/javascript">
var myPestChart = echarts.init(document.getElementById("squery-pest-curve"));
