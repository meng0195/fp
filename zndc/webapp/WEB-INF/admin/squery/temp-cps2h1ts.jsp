...
<form id="pagerForm" onsubmit="return navTabSearch(this);" action="${CTX_PATH}/squery/temp/cps2h1ts" method="post">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<th>仓房1：</th>
				<td>
					<select id="squery-cps2h1ts-houseNo1" name="t1.houseNo" class="combox">
			  	...
			  	<th>仓房2：</th>
				<td>
					<select id="squery-cps2h1ts-houseNo2" name="t2.houseNo" class="combox">
						<option value="">请选择</option>
						<c:forEach var="house" items="${codes['houses']}">
			  				<option value="${house.key}" ${t2.houseNo == house.key ? 'selected' : ''}>${house.value}</option>
			  			</c:forEach>
			  		</select>
			  	</td>
			  	<th>开始时间：</th>
...
<div width="100%" layoutH="30" style="margin-top: 15px;">
	<div id="squery-cps2h1ts-left" style="width:47%;height:450px;margin:0 auto;float: left;"></div>
	<div id="squery-cps2h1ts-right" style="width:47%;height:450px;margin:0 auto;float: right;"></div>
</div>
<script type="text/javascript">
var myChartLeft = echarts.init(document.getElementById("squery-cps2h1ts-left"));
var myChartRight = echarts.init(document.getElementById("squery-cps2h1ts-right"));
