...
<table class="table" width="2140px" layoutH="95">
	<tr class="report">
		...
		<th colspan="25" width="1500">粮温情况(℃)</th>
		<th rowspan="3" width="80">操作</th>
	</tr>
	<tr class="report">
		<th colspan="2">${year}</th>
		<th colspan="4" width="240">中央</th>
		<th colspan="4" width="240">东南角</th>
		<th colspan="4" width="240">西南角</th>
		<th colspan="4" width="240">西北角</th>
		<th colspan="4" width="240">东北角</th>
	...
	<c:forEach var="u" items="${reports}" varStatus="st">
		<tr target="uid" rel="${u.id}">
			...
			<td class="center">${u.a41 != -1024 ? u.a41 : '-'}</td>
			<td class="center">${u.a42 != -1024 ? u.a42 : '-'}</td>
			<td class="center">${u.a43 != -1024 ? u.a43 : '-'}</td>
			<td class="center">${u.a44 != -1024 ? u.a44 : '-'}</td>
			<td class="center">${u.a51 != -1024 ? u.a51 : '-'}</td>
			<td class="center">${u.a52 != -1024 ? u.a52 : '-'}</td>
			<td class="center">${u.a53 != -1024 ? u.a53 : '-'}</td>
			<td class="center">${u.a54 != -1024 ? u.a54 : '-'}</td>
	...
	<c:forEach begin="1" end="${page.pageSize - fn:length(page.result)}">
		<tr target="uid" rel=""><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
	</c:forEach>
</table>
